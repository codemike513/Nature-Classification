...
async def create_upload_files(files: List[UploadFile] = File(...)):
    ...
    content = head_html + """
    <marquee width="680" behavior="alternate"><h1 style="color:white;font-family:Roboto;font-size:250%;">Here's Our Predictions!</h1></marquee>
...
async def main():
    content = head_html + """
    <marquee width="600" behavior="alternate"><h1 style="color:white;font-family:Roboto;font-size:200%;">The Nature Classification Project</h1></marquee>
    <h3 style="color:white;font-family:Roboto">We'll try to Predict to which of these Categories our image belongs:</h3><br>
    """
...
def get_html_table(image_paths, names, column_labels):
    ...
    if column_labels:
        s += '<tr><th><h4 style="color:white;font-family:Roboto">' + \
            column_labels[0] + '</h4></th><th><h4 style="color:white;font-family:Roboto">' + \
            column_labels[1] + '</h4></th></tr>'

    for name, image_path in zip(names, image_paths):
        s += '<tr><td><img height="80" src="/' + image_path + '" ></td>'
        s += '<td style="color:white;text-align:center">' + name + '</td></tr>'
    s += '</table>'
